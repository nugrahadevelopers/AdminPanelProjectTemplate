    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="{{ route('admin.dashboard.index') }}">
                <img src="{{ asset('static/logo-white.png') }}" width="110" height="32" alt="Tabler"
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <x-navbar-menu-wrapper>
                <x-navbar-menu-item link="{{ route('admin.dashboard.index') }}" :label="trans('layout.navigation.dashboard')">
                    <x-slot name="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                ...
                <x-navbar-menu-item-dropdown link="/" :label="trans('layout.navigation.user_management')">
                    <x-slot name="icon">
